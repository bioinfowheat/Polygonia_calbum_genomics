...
#Annotation using only bam files from RNAseq
...
braker.pl --genome=$genome --bam=$bamfiles --softmasking
...
ln -s /assemblies/Pcalbum_chromosome_and_unplaced.fa .
...
bash redmask.sh Pca_genome.fasta Pcalbum_chromosome_and_unplaced.fa
